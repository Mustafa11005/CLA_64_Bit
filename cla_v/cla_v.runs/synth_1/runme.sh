...
HD_PWD='D:/Mustafa/Projects/Digital_Design/CLA_64_Bit_N/cla_v/cla_v.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLA_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLA_top.tcl
